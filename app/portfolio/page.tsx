  ...
  const projects = [
    {
      ...
      description:
        "A conversion-focused, mobile-first website designed to turn product discovery into enquiries and sales.",
    ...
    },
    {
      ...
      description:
        "A connected SEO, content and social strategy built to create consistent organic visibility and qualified traffic.",
    ...
    },
    {
      ...
      description:
        "A complete visual direction with a sharper digital identity, messaging system and conversion-ready brand assets.",
    ...
    },
    {
      ...
      description:
        "Technical improvements, on-page SEO and content structure designed to make a website easier to discover and use.",
    ...
    },
    {
      ...
      description:
        "A social content framework connecting attention-grabbing creative with clear calls to action and measurable goals.",
    ...
    },
    {
      ...
      description:
        "A practical AI workflow for research, content ideation, campaign planning and faster marketing execution.",
    ...
    <main className="min-h-screen bg-gradient-to-br from-black via-zinc-950 to-black text-white overflow-hidden">
      ...
      <header className="relative z-10 border-b border-white/10 bg-black/40 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <a
            ...
            className="px-5 py-2.5 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 font-semibold text-sm hover:scale-105 transition"
          >
            Book a Free Call
          </a>
        </div>
      ...
      <section className="relative z-10 px-6 pt-24 pb-16">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-black mt-5 leading-tight max-w-4xl">
            Work built to move
            <span className="text-blue-400"> brands forward.</span>
          </h1>
          <p className="text-gray-400 text-lg md:text-xl leading-8 max-w-2xl mt-6">
            Websites, branding and marketing systems designed around one goal:
            turning digital attention into real business growth.
          </p>
        </div>
      </section>

      <section className="relative z-10 px-6 pb-24">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-7">
          {projects.map((project) => (
            ...
            >
              <div className={`h-44 bg-gradient-to-br ${project.accent} relative`}>
                <div className="absolute inset-5 rounded-2xl border border-white/10 bg-black/20 backdrop-blur-sm">
                  <div className="absolute top-5 left-5 text-xs uppercase tracking-widest text-gray-300">
                    BrandPilot / {project.category}
                  </div>
      ...
      <section className="relative z-10 px-6 pb-24">
        <div className="max-w-4xl mx-auto rounded-3xl border border-blue-400/20 bg-blue-500/[0.06] p-10 md:p-14 text-center">
          <p className="text-blue-400 text-sm uppercase tracking-[0.3em] font-semibold">
            Your brand next?
          </p>
          ...
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto leading-7">
            Tell us what you&apos;re trying to achieve and we&apos;ll map out the
            clearest digital path forward.
          </p>
          <a
            href="/#contact"
            className="inline-flex mt-8 px-8 py-4 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 font-bold hover:scale-105 transition"
          >
            Start Your Project →
          </a>
        </div>
